        ...
        <section id="hero" className="pt-20 pb-24 max-w-content mx-auto px-6">
          ...
          <div className="flex flex-wrap items-center gap-4 mb-10" aria-label="Supported platforms">
            {[
              ...
              { name: 'Threads',   color: '#e8e6e0', bg: '#111111', icon: <svg viewBox="0 0 192 192" width="20" height="20" fill="currentColor"><path d="M141.537 88.988a66.667 66.667 0 0 0-2.518-1.143c-1.482-27.307-16.403-42.94-41.457-43.1h-.34c-14.986 0-27.449 6.396-35.12 18.036l13.779 9.452c5.73-8.695 14.723-10.548 21.348-10.548h.232c8.248.054 14.474 2.452 18.502 7.13 2.932 3.405 4.893 8.111 5.864 14.05-7.314-1.244-15.224-1.626-23.68-1.14-23.82 1.371-39.134 15.264-38.105 34.568.522 9.792 5.4 18.216 13.735 23.719 7.047 4.652 16.124 6.927 25.557 6.412 12.458-.683 22.231-5.436 29.049-14.127 5.178-6.6 8.453-15.153 9.899-25.93 5.937 3.583 10.337 8.298 12.767 13.966 4.132 9.635 4.373 25.468-8.546 38.376-11.319 11.308-24.925 16.2-45.488 16.35-22.809-.169-40.06-7.484-51.275-21.742C35.236 139.966 29.808 120.682 29.605 96c.203-24.682 5.63-43.966 16.133-57.317C56.954 24.425 74.204 17.11 97.013 16.94c22.975.17 40.526 7.52 52.171 21.847 5.71 7.026 10.015 15.86 12.853 26.162l16.147-4.308c-3.44-12.68-8.853-23.606-16.219-32.668C147.036 9.607 125.202.195 97.07 0h-.113C68.882.195 47.292 9.642 32.788 28.08 19.882 44.485 13.224 67.315 13.001 96v.065c.223 28.685 6.88 51.515 19.787 67.92 14.504 18.438 36.094 27.885 64.174 28.08h.113c25.021-.173 42.derecho637-6.93 57.157-21.438 19.011-18.982 18.441-42.713 12.22-57.273-4.515-10.517-13.193-19.173-25.915-25.366Z"/></svg> },
