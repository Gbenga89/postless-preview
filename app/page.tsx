        ...
        <section id="hero" className="pt-20 pb-24 max-w-content mx-auto px-6">
          ...
          <div className="flex flex-wrap items-center gap-4 mb-10" aria-label="Supported platforms">
            {[
              ...
              { name: 'Threads',   color: '#e8e6e0', bg: '#111111', icon: <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9d/Threads_%28app%29_logo.svg/120px-Threads_%28app%29_logo.svg.png" width="20" height="20" alt="Threads" style={{filter:"invert(1)"}} /> },
